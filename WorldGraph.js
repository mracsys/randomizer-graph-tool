            ...
            for (let loc of world.get_locations()) {
                ...
                if (loc.name === 'ToT Light Arrows Cutscene' && world.settings.shuffle_ganon_bosskey === 'on_lacs') {
                    ...
                    if (loc.vanilla_item.name === dungeon_text('Boss Key', dungeon)) {
                        ...
                        if (world.settings.key_rings.includes(dungeon) && dungeon !== 'Ganons Castle' && world.settings.keyring_give_bk && world.settings.shuffle_smallkeys == 'remove' && ['remove', 'any_dungeon', 'overworld', 'keysanity', 'regional'].includes(shuffle_setting)) {
