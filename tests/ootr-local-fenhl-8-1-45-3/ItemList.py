...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Easter Egg (Blue)':                               ('Item',     True,  0x1003, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),

    'Triforce of Power':                               ('Item',     True,  0x1004, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Wisdom':                              ('Item',     True,  0x1005, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Courage':                             ('Item',     True,  0x1006, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
