...
class SettingInfos:
    ...
    presets = SettingInfoStr(
        ...
        gui_tooltip    = '''\
            ...
            <a href="https://tootr.mracsys.com/">TOoTR</a> disabled.
    ...
    empty_dungeons_rewards = MultipleSelect(
        ...
        default         = [],
        gui_tooltip     = '''\
            Select the specific dungeon rewards whose
    ...
    shuffle_hideout_entrances = Combobox(
        ...
        gui_tooltip    = '''\
            ...
            torch), as in the vanilla game. If set to "On (Savewarp to
            Overworld)", savewarping in the Hideout takes you to the
            overworld spawn depending on Link's current age.
        ''',
        shared         = True,
        disable        = {
    ...
    shuffle_base_item_pool = Checkbutton(
        ...
        gui_tooltip    = '''\
            ...
            Turning this off currently does not work with Master
            Quest, and may not work properly with glitched logic.
        ''',
        default        = True,
        disabled_default = False,
        disable        = {
