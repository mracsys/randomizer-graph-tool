...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Easter Egg (Pink)':                               ('Item',     True,  GetItemId.GI_EASTER_EGG_PINK, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Orange)':                             ('Item',     True,  GetItemId.GI_EASTER_EGG_ORANGE, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Green)':                              ('Item',     True,  GetItemId.GI_EASTER_EGG_GREEN, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Easter Egg (Blue)':                               ('Item',     True,  GetItemId.GI_EASTER_EGG_BLUE, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),

    'Triforce of Power':                               ('Item',     True,  GetItemId.GI_TRIFORCE_OF_POWER, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Wisdom':                              ('Item',     True,  GetItemId.GI_TRIFORCE_OF_WISDOM, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
    'Triforce of Courage':                             ('Item',     True,  GetItemId.GI_TRIFORCE_OF_COURAGE, {'alias': ('Triforce Piece', 1), 'progressive': float('Inf')}),
