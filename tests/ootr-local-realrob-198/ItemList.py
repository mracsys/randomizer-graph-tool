...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Stalfos Soul':                                    ('Item',     True,  0x011B, None),
    'Octorok Soul':                                    ('Item',     True,  0x011C, None),
    'Wallmaster Soul':                                 ('Item',     True,  0x011D, None),
    'Dodongo Soul':                                    ('Item',     True,  0x011E, None),
    'Keese Soul':                                      ('Item',     True,  0x011F, None),
    'Tektite Soul':                                    ('Item',     True,  0x0120, None),
    'Peahat Soul':                                     ('Item',     True,  0x0121, None),
    'Lizalfos and Dinalfos Soul':                      ('Item',     True,  0x0122, None),
    'Gohma Larvae Soul':                               ('Item',     True,  0x0123, None),
    'Shabom Soul':                                     ('Item',     True,  0x0124, None),
    'Baby Dodongo Soul':                               ('Item',     True,  0x0125, None),
    'Biri and Bari Soul':                              ('Item',     True,  0x0126, None),
    'Tailpasaran Soul':                                ('Item',     True,  0x0127, None),
    'Skulltula Soul':                                  ('Item',     True,  0x0128, None),
    'Torch Slug Soul':                                 ('Item',     True,  0x0129, None),
    'Moblin Soul':                                     ('Item',     True,  0x012A, None),
    'Armos Soul':                                      ('Item',     True,  0x012B, None),
    'Deku Baba Soul':                                  ('Item',     True,  0x012C, None),
    'Deku Scrub Soul':                                 ('Item',     True,  0x012D, None),
    'Bubble Soul':                                     ('Item',     True,  0x012E, None),
    'Beamos Soul':                                     ('Item',     True,  0x012F, None),
    'Floormaster Soul':                                ('Item',     True,  0x0130, None),
    'Redead and Gibdo Soul':                           ('Item',     True,  0x0131, None),
    'Skullwalltula Soul':                              ('Item',     True,  0x0132, None),
    'Flare Dancer Soul':                               ('Item',     True,  0x0133, None),
    'Dead hand Soul':                                  ('Item',     True,  0x0134, None),
    'Shell blade Soul':                                ('Item',     True,  0x0135, None),
    'Like-like Soul':                                  ('Item',     True,  0x0136, None),
    'Spike Enemy Soul':                                ('Item',     True,  0x0137, None),
    'Anubis Soul':                                     ('Item',     True,  0x0138, None),
    'Iron Knuckle Soul':                               ('Item',     True,  0x0139, None),
    'Skull Kid Soul':                                  ('Item',     True,  0x013A, None),
    'Flying Pot Soul':                                 ('Item',     True,  0x013B, None),
    'Freezard Soul':                                   ('Item',     True,  0x013C, None),
    'Stinger Soul':                                    ('Item',     True,  0x013D, None),
    'Wolfos Soul':                                     ('Item',     True,  0x013E, None),
    'Guay Soul':                                       ('Item',     True,  0x013F, None),
    'Queen Gohma Soul':                                ('Item',     True,  0x0140, None),
    'King Dodongo Soul':                               ('Item',     True,  0x0141, None),
    'Barinade Soul':                                   ('Item',     True,  0x0142, None),
    'Phantom Ganon Soul':                              ('Item',     True,  0x0143, None),
    'Volvagia Soul':                                   ('Item',     True,  0x0144, None),
    'Morpha Soul':                                     ('Item',     True,  0x0145, None),
    'Bongo Bongo Soul':                                ('Item',     True,  0x0146, None),
    'Twinrova Soul':                                   ('Item',     True,  0x0147, None),
    'Jabu Jabu Tentacle Soul':                         ('Item',     True,  0x0148, None),
    'Dark Link Soul':                                  ('Item',     True,  0x0149, None),
