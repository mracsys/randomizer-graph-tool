...
class GetItemId(IntEnum):
    ...
    GI_FISHING_ROD = 0x0245
    GI_FISH_CHILD_6LB = 0x0246
    GI_FISH_CHILD_8LB = 0x0247
    GI_FISH_CHILD_10LB = 0x0248
    GI_FISH_ADULT_10LB = 0x0249
    GI_FISH_ADULT_12LB = 0x024A
    GI_FISH_ADULT_16LB = 0x024B
    GI_FISH_LOACH = 0x024C
...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Fishing Rod':                                     ('Item',     True,  GetItemId.GI_FISHING_ROD, None),
    'Fish (Child 6 lb)':                               ('Fish',     None,  GetItemId.GI_FISH_CHILD_6LB, None),
    'Fish (Child 8 lb)':                               ('Fish',     None,  GetItemId.GI_FISH_CHILD_8LB, None),
    'Fish (Child 10 lb)':                              ('Fish',     True,  GetItemId.GI_FISH_CHILD_10LB, None),
    'Fish (Adult 10 lb)':                              ('Fish',     None,  GetItemId.GI_FISH_ADULT_10LB, None),
    'Fish (Adult 12 lb)':                              ('Fish',     None,  GetItemId.GI_FISH_ADULT_12LB, None),
    'Fish (Adult 16 lb)':                              ('Fish',     True,  GetItemId.GI_FISH_ADULT_16LB, None),
    'Hylian Loach':                                    ('Fish',     True,  GetItemId.GI_FISH_LOACH, None),
