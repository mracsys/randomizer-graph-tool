...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Stalfos Soul':                                    ('Soul',     True,  0x2000, None),
    'Octorok Soul':                                    ('Soul',     True,  0x2001, None),
    'Wallmaster Soul':                                 ('Soul',     True,  0x2002, None),
    'Dodongo Soul':                                    ('Soul',     True,  0x2003, None),
    'Keese Soul':                                      ('Soul',     True,  0x2004, None),
    'Tektite Soul':                                    ('Soul',     True,  0x2005, None),
    'Peahat Soul':                                     ('Soul',     True,  0x2006, None),
    'Lizalfos and Dinalfos Soul':                      ('Soul',     True,  0x2007, None),
    'Gohma Larvae Soul':                               ('Soul',     True,  0x2008, None),
    'Shabom Soul':                                     ('Soul',     True,  0x2009, None),
    'Baby Dodongo Soul':                               ('Soul',     True,  0x200A, None),
    'Biri and Bari Soul':                              ('Soul',     True,  0x200B, None),
    'Tailpasaran Soul':                                ('Soul',     True,  0x200C, None),
    'Skulltula Soul':                                  ('Soul',     True,  0x200D, None),
    'Torch Slug Soul':                                 ('Soul',     True,  0x200E, None),
    'Moblin Soul':                                     ('Soul',     True,  0x200F, None),
    'Armos Soul':                                      ('Soul',     True,  0x2010, None),
    'Deku Baba Soul':                                  ('Soul',     True,  0x2011, None),
    'Deku Scrub Soul':                                 ('Soul',     True,  0x2012, None),
    'Bubble Soul':                                     ('Soul',     True,  0x2013, None),
    'Beamos Soul':                                     ('Soul',     True,  0x2014, None),
    'Floormaster Soul':                                ('Soul',     True,  0x2015, None),
    'Redead and Gibdo Soul':                           ('Soul',     True,  0x2016, None),
    'Skullwalltula Soul':                              ('Soul',     True,  0x2017, None),
    ...
    'Skull Kid Soul':                                  ('Soul',     True,  0x201F, None),
    'Flying Pot Soul':                                 ('Soul',     True,  0x2020, None),
    'Freezard Soul':                                   ('Soul',     True,  0x2021, None),
    'Stinger Soul':                                    ('Soul',     True,  0x2022, None),
    'Wolfos Soul':                                     ('Soul',     True,  0x2023, None),
    'Guay Soul':                                       ('Soul',     True,  0x2024, None),
    'Queen Gohma Soul':                                ('Soul',     True,  0x2025, None),
    'King Dodongo Soul':                               ('Soul',     True,  0x2026, None),
    'Barinade Soul':                                   ('Soul',     True,  0x2027, None),
    'Phantom Ganon Soul':                              ('Soul',     True,  0x2028, None),
    'Volvagia Soul':                                   ('Soul',     True,  0x2029, None),
    'Morpha Soul':                                     ('Soul',     True,  0x202A, None),
    'Bongo Bongo Soul':                                ('Soul',     True,  0x202B, None),
    ...
    'Forest Temple Souls':                             ('Soul',     True,  0x2032, None),
    'Fire Temple Souls':                               ('Soul',     True,  0x2033, None),
    'Water Temple Souls':                              ('Soul',     True,  0x2034, None),
    'Shadow Temple Souls':                             ('Soul',     True,  0x2035, None),
    'Spirit Temple Souls':                             ('Soul',     True,  0x2036, None),
    'Bottom of the Well Souls':                        ('Soul',     True,  0x2037, None),
    'Ice Cavern Souls':                                ('Soul',     True,  0x2038, None),
    'Gerudo Training Ground Souls':                    ('Soul',     True,  0x2039, None),
    'Ganons Castle Souls':                             ('Soul',     True,  0x203A, None),
    'Forest Area Souls':                               ('Soul',     True,  0x203B, None),
    'Hyrule Field Souls':                              ('Soul',     True,  0x203C, None),
    'Lake Hylia Souls':                                ('Soul',     True,  0x203D, None),
    'Gerudo Area Souls':                               ('Soul',     True,  0x203E, None),
    'Market Area Souls':                               ('Soul',     True,  0x203F, None),
    'Kakariko Area Souls':                             ('Soul',     True,  0x2040, None),
    'Goron Area Souls':                                ('Soul',     True,  0x2041, None),
    'Zora Area Souls':                                 ('Soul',     True,  0x2042, None),
    'Lon Lon Ranch Souls':                             ('Soul',     True,  0x2043, None),
    'Grottos Souls':                                   ('Soul',     True,  0x2044, None),

    'Fishing Rod':                                     ('Item',     True,  0x2100, None),
    'Fish (Child 6 lb)':                               ('Fish',     None,  0x2101, None),
    'Fish (Child 8 lb)':                               ('Fish',     None,  0x2102, None),
    'Fish (Child 10 lb)':                              ('Fish',     True,  0x2103, None),
    'Fish (Adult 10 lb)':                              ('Fish',     None,  0x2104, None),
    'Fish (Adult 12 lb)':                              ('Fish',     None,  0x2105, None),
    'Fish (Adult 16 lb)':                              ('Fish',     True,  0x2106, None),
    'Hylian Loach':                                    ('Fish',     True,  0x2107, None),
